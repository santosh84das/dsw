...
if($remote_addr=='10.173.89.71' || $remote_addr=='10.173.89.72' || $remote_addr=='10.173.89.76' || $remote_addr=='10.173.89.35' || $remote_addr=='10.173.88.39' || $remote_addr=='10.173.88.37' || $remote_addr=='10.173.88.41' || $remote_addr=='10.173.65.38'){
...
$rt=(int)$data['r_no'];
$scl_dtl=mysql_query("select * from online_scl_dtl where r_no_frm<=".$rt." and r_no_to>=".$rt);
					...
					<table border="0" cellpadding="0" cellspacing="0" width="480" align="center">
						<tr>
							<td align="left" width="320" style="padding-bottom:5px;"><span class="style-ad-6"><br />
								<strong>EXAMINATION VENUE</strong></span></td>
						...
						<tr>
							...
							//if($s_dtl['ex_cnt_no']!=''){
								//$var.=', Contact NO : '.$s_dtl['ex_cnt_no'];
							//}

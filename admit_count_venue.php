...
$all_y=mysql_num_rows(mysql_query("select distinct exm_roll from online_app_zp_ttb where print_chk!='y'"));
$post1=mysql_num_rows(mysql_query("select distinct exm_roll from online_app_zp_ttb where print_chk!='y' and cand_post='post1'"));
...
<tr>
	<td>EXECUTIVE ASSISTANT </td><td><?php echo $post1;?></td>
</tr>
<tr>
	<td>NIRMAN SAHAYAK </td><td><?php echo $post2;?></td>
</tr>
<tr>

...
if(isset($_REQUEST['r_no'])){
		...
		$data_reg=mysql_query("select * from online_app_zp_f_ttb where r_no=".$r_no);
		$data=mysql_fetch_array($data_reg);
}else{
	?>
	<script language="javascript">
	window.location='li_roll.php';
	</script>
	<?php 
	exit();
}
...
<p class="MsoNormal" align="center" style="margin-bottom:.0001pt;text-align:center;line-height:normal;"><strong><span style="font-family:Cambria,serif; ">BARASAT, NORTH 24 PARGANAS</span></strong><strong><u><span style="font-family:Cambria,serif; font-size:14.0pt; "> </span></u></strong></p>
<p class="MsoNormal"><span style="line-height:115%; font-family:Cambria,serif; font-size:12.0pt; ">&nbsp;</span></p>
<p class="MsoNormal"> <span style="font-family:Cambria,serif; font-size:12.0pt; "><table width="100%"><tr><td align="left"> No. <b>1416(143)/DPO.XIX(B)/2012</b></td><td align="right">Date: <b>24.09.2013</b></td></tr></table></span></p>
...
if($data['cand_sex']=='M'){$var.='Sri';}
else if($data['cand_sex']=='F'){$var.='Smt';}
else {$var.='Sri/Smt.';}
$var.='&nbsp;<b>'.$data['cand_nm'].'</b><br />
...
$var.='</u>  with in this District from panel already published.</span></p>
<p class="MsoNormal" style="text-align:justify;line-height:150%;"><span style="font-family:Cambria,serif; font-size:12.0pt; ">You are requested to submit the filled in PVR Form as supplied with this letter of intimation to the office of the District Panchayat and Rural Development Officer, 2nd Floor, Zilla Parishad Bhavan, Barasat, North 24 Parganas on any working day by 30.10.2013.</span></p>
...
<p class="MsoNormal" align="center" style="margin-bottom:.0001pt;text-align:center;text-indent:269.35pt;"><strong><span style="font-family:Cambria,serif; ">Executive Officer</span></strong></p>
<p class="MsoNormal" align="center" style="margin-bottom:.0001pt;text-align:center;text-indent:269.35pt;"><strong><span style="font-family:Cambria,serif; ">North 24-Parganas Zilla Parishad</span></strong></p>

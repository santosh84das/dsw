...
//** Sept 10th, 08'- Updated to v 1.4:
	...
	//2) Arrow <?=$URL;?>/images now dynamically positioned, instead of relying on CSS's "right" property
...
//** Jan 12, 09'- Updated to v 2.1:
	//1) Added ability to disable the arrow <?=$URL;?>/images from the top level items (see option "showarrow")
	//2) For Top Level Menu items containing a SPAN element (for sliding doors technique), arrow <?=$URL;?>/images are inserted inside SPAN.
...
arrowpointers:{
	downarrow: ["http://north24parganas.gov.in/arrow-down.gif", 11,7], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: ["http://north24parganas.gov.in/arrow-right.gif", 12,12], //[path_to_right_arrow, arrowwidth, arrowheight]
	showarrow: {toplevel: true, sublevel: true} //Show arrow <?=$URL;?>/images on top level items and sub level items, respectively?
},

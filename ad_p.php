...
if(isset($_POST['sub_sub']) && $_POST['sub_sub']=='Submit'){
	...
	if($cand_data[0]==''){
    	...
    	<script>
		window.location='ad_pri.php?r_no=<?php echo $r_no;?>';
		</script>
  		<?php
		exit();
	}
			...
			<div class="midright">
            	<div class="mid_s">
           	  ...
           	  <p align="center" class="stylevr" style="padding-left:50px">
                        ...
                        <table width="366">
                          <tr>
                       		<td>Roll no</td><td><input type="text" maxlength="12" style="font-size:12px; width:180px;" name="r_no" id="r_no" onChange="javascript:this.value=this.value.toUpperCase();" onKeyPress="return all_allow('sub_sub', event)" autocomplete="off" value="<?php if(isset($_POST['sub_sub'])){echo $_POST['r_no'];}?>" /></td></tr>
                                <tr><td></td><td>

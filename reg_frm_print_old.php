...
$pdf->SetFont('Arial','B',$fntsz);
$pdf->Cell($linw/2.5,8,'FATHER`S / HUSBAND NAME',0,0,'L');
...
$pdf->SetFont('Arial','B',$fntsz);
$pdf->Cell($linw/2.5,8,'POLICE STATIONS',0,0,'L');
...
$pdf->Cell($colw*1.6,13,'',1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee1_1'],1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee1_2'],1,0,'L');
...
$get_x=$pdf->GetX();$get_y=$pdf->GetY();
$pdf->Cell($colw*1.6,13,'',1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee2_1'],1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee2_2'],1,0,'L');
...
$d=preg_split("/[.]/",$data['ee2_3']);
					...
					$var=$m;
$pdf->Cell($colw*.7,13,$var,1,0,'L');
$pdf->Cell($colw*.9,13,$data['ee2_4'],1,1,'L');
$pdf->SetXY($get_x,$get_y+.5);
...
$get_x=$pdf->GetX();$get_y=$pdf->GetY();
$pdf->Cell($colw*1.6,13,'',1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee3_1'],1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee3_2'],1,0,'L');
$d=preg_split("/[.]/",$data['ee3_3']);
					...
					$var=$m;
$pdf->Cell($colw*.7,13,$var,1,0,'L');
$pdf->Cell($colw*.9,13,$data['ee3_4'],1,1,'L');
$pdf->SetXY($get_x,$get_y+.5);
...
$get_x=$pdf->GetX();$get_y=$pdf->GetY();
$pdf->Cell($colw*1.6,13,'',1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee4_1'],1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee4_2'],1,0,'L');
$d=preg_split("/[.]/",$data['ee4_3']);
					...
					$var=$m;
$pdf->Cell($colw*.7,13,$var,1,0,'L');
$pdf->Cell($colw*.9,13,$data['ee4_4'],1,1,'L');
$pdf->SetXY($get_x,$get_y+.5);
...
$get_x=$pdf->GetX();$get_y=$pdf->GetY();
$pdf->Cell($colw*1.6,13,'',1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee5_1'],1,0,'L');
$pdf->Cell($colw*1.6,13,$data['ee5_2'],1,0,'L');
$d=preg_split("/[.]/",$data['ee5_3']);
					...
					$var=$m;
$pdf->Cell($colw*.7,13,$var,1,0,'L');
$pdf->Cell($colw*.9,13,$data['ee5_4'],1,1,'L');
$pdf->SetXY($get_x,$get_y+.5);

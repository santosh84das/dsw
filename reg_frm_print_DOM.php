...
<body>
	<div align="center" class="main_body">
    	<div align="center">
            ...
            <span class="style14">
			PRINTED APPLICATION FORM FOR THE POST OF NIRMAN SAHAYAK / EXECUTIVE ASSISTANT <br/><br/><br />
            <hr />
            <br />
        	</span>       	
       	</div>';
...
$var.='    	<div id="c_dtl">
                <div class="c_dtl_l">CANDIDATE PICTURE</div>
              	<div class="c_dtl_r"><div class="style18" style="padding-bottom:5px; "><img src="'.$data['cand_p_pic'].'" style="width:120px; height:160px"><br /></div>';
...
$var.='    	<div id="c_dtl">
                <div class="c_dtl_l">CATEGORY</div>
              	<div class="c_dtl_r">: ';
...
if($data['ck_ex_serv']=='on' || $data['ck_blind']=='on' || $data['ck_hear']=='on' || $data['ck_loco']=='on'|| $data['ck_ec']=='on' ){
$var.='     <div id="c_dtl">
                <div class="c_dtl_l" style="vertical-align:top;">YOU ARE</div>
                <div class="c_dtl_r">';
					if($data['ck_ex_serv']=='on'){$var.=': EX - SERVICEMAN WITH ACTUAL '. $data['ex_serv_yr'].' YR OF SERVICE <br />';}
                    if($data['ck_ec']=='on'){$var.=': EXEMPTED CATEGORY<br />';}
...
$var.='    	<div id="c_dtl">
                <div class="c_dtl_l">AGE(as on 01-01-2016)</div>
              	<div class="c_dtl_r">: ';
...
$var.='    	<div id="c_dtl">
                <div class="c_dtl_l">CANDIDATE SIGNATURE <br/>
				<img src="'.$data['cand_p_sig'].'" style="width:180px; height:90px;"><br/></div>
              	<div class="c_dtl_r"></div>';
$date=date_create($data['cand_app_dt']);
$datefmt=date_format($date,"d/m/Y");			
$var.='    	<div id="c_dtl">
                <div class="c_dtl_l">DATE </div>
              	<div class="c_dtl_r">:'.$datefmt.'<div class="style18" style="padding-bottom:5px; "><br /></div>';
...
//$var='<html><body><h2>hello world</h2></body></html>';
  $dompdf = new DOMPDF();
